...
export const SYSTEM_ENTITY_TYPES = [
  {
    ...
    fields: [
      ...
      // Which to_do/task this row was generated from, if it was generated by
      // recurrence - not entity_relationships, because the source side is not
      // guaranteed to still exist (recurrence predates the todos/tasks
      // migration to entities). Engine-written, never rendered as a control.
      { field_key: 'recurring_from_todo_id', label: 'Recurring from to-do', field_type: 'number', required: false, show_in_row: false },
      { field_key: 'recurring_from_task_id', label: 'Recurring from task', field_type: 'number', required: false, show_in_row: false },
    ],
  },
  {
    slug: 'priority',
...
export const SYSTEM_TYPE_RELATIONSHIPS = [
  ...
  { type_slugs_parent: 'to_do', type_slugs_child: 'daily', relationship_kind: 'recurrence', max_children_per_parent: null, max_parents_per_child: 1 },
  { type_slugs_parent: 'task', type_slugs_child: 'daily', relationship_kind: 'recurrence', max_children_per_parent: null, max_parents_per_child: 1 },
