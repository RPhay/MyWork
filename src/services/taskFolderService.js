...
export async function updateFolder(id, data) {
  ...
  // Only touch name when the caller explicitly provided it, so a priority_id-only
  // update (linking/unlinking a folder to a project) doesn't require re-sending it.
