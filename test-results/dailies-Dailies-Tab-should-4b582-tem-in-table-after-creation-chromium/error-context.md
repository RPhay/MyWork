...
- Name: dailies.spec.js >> Dailies Tab >> should show work item in table after creation
- Location: tests/e2e/dailies.spec.js:49:3
...
Call log:
  - waiting for locator('#workItemsTableBody')
...
- generic [ref=e1]:
        ...
        - generic [ref=e34]:
          ...
          - generic [ref=e120]:
            - generic [ref=e121]:
              ...
              - button "+ Add" [active] [ref=e123] [cursor=pointer]
            - generic [ref=e124]:
              ...
              - generic "Click to change status, double-click to edit; drag to reorder" [ref=e160] [cursor=pointer]:
                ...
                - generic [ref=e168]:
                  ...
                  - button "Delete" [ref=e171]:
                    - generic [ref=e172]: 
              - generic "Click to change status, double-click to edit; drag to reorder" [ref=e174] [cursor=pointer]:
                - generic [ref=e175]:
                  - generic "Expand/collapse" [ref=e176]: 
                  - generic "Work Item" [ref=e177]: 
                  - generic [ref=e178]: Test Work Item
                - generic "Oh! Click to pick an emoji" [ref=e179]
                - generic "Click to change status" [ref=e180]: Not Started
                - generic "Click to change time box" [ref=e181]: No time box
                - generic [ref=e182]:
                  - button "Edit" [ref=e183]:
                    - generic [ref=e184]: 
                  - button "Delete" [ref=e185]:
                    - generic [ref=e186]: 
              - generic "Click to change status, double-click to edit; drag to reorder" [ref=e188] [cursor=pointer]:
                - generic [ref=e189]:
                  - generic "Expand/collapse" [ref=e190]: 
                  - generic "Work Item" [ref=e191]: 
                  - generic [ref=e192]: My Test Task
                - generic "Oh! Click to pick an emoji" [ref=e193]
                - generic "Click to change status" [ref=e194]: Not Started
                - generic "Click to change time box" [ref=e195]: No time box
                - generic [ref=e196]:
          ...
          - generic [ref=e201]:
            - list [ref=e202]:
              - listitem [ref=e203]:
                - button "Projects" [ref=e204] [cursor=pointer]
              - listitem [ref=e205]:
                - button "Goals" [ref=e206] [cursor=pointer]
              - listitem [ref=e207]:
                - button "Categories" [ref=e208] [cursor=pointer]
              - listitem [ref=e209]:
                - button "Templates" [ref=e210] [cursor=pointer]
            - text:        
            - generic [ref=e211]:
              - generic [ref=e212]:
                - generic [ref=e213]:
  ...
  - contentinfo [ref=e220]:
    - paragraph [ref=e222]: © 2026 MyWork. Licensed under the MIT License.
  - text:         
```
