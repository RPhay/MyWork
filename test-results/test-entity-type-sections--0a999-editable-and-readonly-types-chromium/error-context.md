...
- Name: test-entity-type-sections.spec.js >> Entity Types - Section Display >> should have separate lists for editable and readonly types
- Location: tests/e2e/test-entity-type-sections.spec.js:96:3
...
Locator: locator('text=Editable Types')
Expected: visible
Error: strict mode violation: locator('text=Editable Types') resolved to 2 elements:
    1) <p class="text-muted mb-4">Manage editable types and templates that organize…</p> aka getByText('Manage editable types and')
    2) <h4 class="mb-0">Editable Types</h4> aka getByRole('heading', { name: 'Editable Types' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('text=Editable Types')
