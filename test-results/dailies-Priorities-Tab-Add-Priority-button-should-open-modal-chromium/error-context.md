...
- Location: tests/e2e/dailies.spec.js:79:3
...
Call log:
  - waiting for locator('button:has-text("+ Add Priority")')
    - locator resolved to <button data-bs-toggle="modal" class="btn btn-primary" data-bs-target="#priorityModal" onclick="openNewPriorityForm()">↵      + Add Priority↵    </button>
