...
- Name: dailies.spec.js >> Priorities Tab >> Add Priority button should open modal
- Location: tests/e2e/dailies.spec.js:80:3
...
- generic [active] [ref=e1]:
  ...
  - text:                                                                                                              
  - contentinfo [ref=e80]:
    - paragraph [ref=e82]: © 2026 MyWork. Licensed under the MIT License.
  - text:     
```
...
```ts
  ...
  11  |     // Calendar should contain month name or year
  12  |     expect(calendar).toMatch(/\d{4}|January|February|March|April|May|June|July|August|September|October|November|December/);
  13  |   });
  14  | 
  15  |   test('should not show loading message when no data', async ({ page }) => {
