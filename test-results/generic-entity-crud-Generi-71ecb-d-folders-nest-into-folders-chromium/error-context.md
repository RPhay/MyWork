...
- Name: generic-entity-crud.spec.js >> Generic entity CRUD - Goals >> items nest into folders and folders nest into folders
...
Expected value: ObjectContaining {"child_entity_id": 7612, "parent_entity_id": 7611}
Received array: [{"child_entity_id": 1647, "order_index": 0, "parent_entity_id": 1646}, {"child_entity_id": 1648, "order_index": 0, "parent_entity_id": 1647}, {"child_entity_id": 7611, "order_index": 0, "parent_entity_id": 7610}]
```
          ...
          - generic [ref=f1e163]:
            ...
            - group [ref=f1e171]:
              - button " + Folder" [ref=f1e172] [cursor=pointer]:
                - generic [ref=f1e173]: 
                - text: + Folder
              - button "+ New Goal" [ref=f1e174] [cursor=pointer]
          - text: 
          - generic [ref=f1e176]:
            - generic [ref=f1e177]:
              ...
              - generic "Drag to reorder columns" [ref=f1e182]:
                - button "Year" [ref=f1e183] [cursor=pointer]
              - generic "Drag to reorder columns" [ref=f1e184]:
                - button "Status" [ref=f1e185] [cursor=pointer]
              - generic "Drag to reorder columns" [ref=f1e186]:
                - button "Description" [ref=f1e187] [cursor=pointer]
              - generic "Drag to reorder columns" [ref=f1e188]:
                - button "Due Date" [ref=f1e189] [cursor=pointer]
              - generic "Drag to reorder columns" [ref=f1e190]:
                - button "Measurements" [ref=f1e191] [cursor=pointer]
              - generic "Drag to reorder columns" [ref=f1e192]:
                - button "Goal Updates" [ref=f1e193] [cursor=pointer]
              - generic "Drag to reorder columns" [ref=f1e194]:
                - button "Notes" [ref=f1e195] [cursor=pointer]
              - group [ref=f1e197]:
              ...
              - generic [ref=f1e203]:
                - generic [ref=f1e205]:
                  - generic [ref=f1e206]:
                    ...
                    - generic [ref=f1e208]: 📁
                    - generic: F1
                    - generic "1 item inside" [ref=f1e209]: (1)
                  - generic "Rolled up from the items inside" [ref=f1e211]: In Progress
                  - generic [ref=f1e212]: 2026-08-07
                  - button "Delete" [ref=f1e214] [cursor=pointer]:
                    - generic [ref=f1e215]: 
                - generic [ref=f1e217]:
                  - generic [ref=f1e219]:
                    - generic [ref=f1e220]:
                      ...
                      - generic [ref=f1e222]: 🎯
                      - generic: G1sss
                      - generic "1 item inside" [ref=f1e223]: (1)
                    - button "No priority - click for Low" [ref=f1e225] [cursor=pointer]
                    - combobox "Year" [ref=f1e232] [cursor=pointer]:
                      - option "—" [selected]
                      - option "2026"
                      - option "2027"
                      - option "2028"
                      - option "2029"
                      - option "2030"
                    - button "In Progress" [ref=f1e234] [cursor=pointer]
                    - button "2026-08-07" [ref=f1e236] [cursor=pointer]
                    - button "Delete" [ref=f1e238] [cursor=pointer]:
                      - generic [ref=f1e239]: 
                  - generic [ref=f1e243]:
                    - generic [ref=f1e244]:
                      - generic [ref=f1e245]: 🎯
                      - generic: G2
                    - button "No priority - click for Low" [ref=f1e247] [cursor=pointer]
                    - combobox "Year" [ref=f1e254] [cursor=pointer]:
                      - option "—" [selected]
                      - option "2026"
                      - option "2027"
                      - option "2028"
                      - option "2029"
                      - option "2030"
                    - button "Complete" [ref=f1e256] [cursor=pointer]
                    - button "2026-08-21" [ref=f1e258] [cursor=pointer]
                    - button "Delete" [ref=f1e260] [cursor=pointer]:
                      - generic [ref=f1e261]: 
              - generic [ref=f1e264]:
                - generic [ref=f1e265]:
                  - generic [ref=f1e266]: 📁
                  - generic [ref=f1e267]: F2
              ...
              - generic [ref=f1e271]:
                - generic [ref=f1e273]:
                  - generic [ref=f1e274]:
                    ...
                    - generic [ref=f1e276]: 📁
                    - generic: ZZZ e2e goal outer folder
                    - generic "1 item inside" [ref=f1e277]: (1)
                  - button "Delete" [ref=f1e279] [cursor=pointer]:
                    - generic [ref=f1e280]: 
                - generic [ref=f1e284]:
                  - generic [ref=f1e285]:
                    - generic [ref=f1e286]: 📁
                    - generic [ref=f1e287]: ZZZ e2e goal inner folder
                  - button "Delete" [ref=f1e289] [cursor=pointer]:
                    - generic [ref=f1e290]: 
              - generic [ref=f1e293]:
                - generic [ref=f1e294]:
                  - generic [ref=f1e295]: 🎯
                  - generic [ref=f1e296]: ZZZ e2e goal nested item
                - button "No priority - click for Low" [ref=f1e298] [cursor=pointer]
                - combobox "Year" [ref=f1e305] [cursor=pointer]:
                  - option "—" [selected]
                  - option "2026"
                  - option "2027"
                  - option "2028"
                  - option "2029"
                  - option "2030"
                - button "Not Started" [active] [ref=f1e307] [cursor=pointer]
                - button "Set date" [ref=f1e309] [cursor=pointer]
                - button "Delete" [ref=f1e311] [cursor=pointer]:
                  - generic [ref=f1e312]: 
        - text:                                            
  - contentinfo [ref=f1e313]:
    - paragraph [ref=f1e315]: © 2026 MyWork. Licensed under the MIT License.
  - text:    
```
