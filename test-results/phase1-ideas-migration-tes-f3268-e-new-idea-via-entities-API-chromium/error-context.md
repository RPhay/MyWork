...
- Name: phase1-ideas-migration-test.spec.js >> Phase 1: Ideas Migration >> Can create new idea via entities API
- Location: tests/e2e/phase1-ideas-migration-test.spec.js:75:3
...
```ts
  ...
  2   | 
  3   | test.describe('Phase 1: Ideas Migration', () => {
