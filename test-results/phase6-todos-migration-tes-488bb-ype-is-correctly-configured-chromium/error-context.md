...
- Name: phase6-todos-migration-test.spec.js >> Phase 6: Todos Migration >> Todo type is correctly configured
- Location: tests/e2e/phase6-todos-migration-test.spec.js:43:3
