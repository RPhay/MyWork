...
- Name: dailies.spec.js >> Settings Tab >> should fill and submit source form
- Location: tests/e2e/dailies.spec.js:167:3
...
Call log:
  - waiting for locator('button:has-text("+ Add Data Source")')
    - locator resolved to <button data-bs-toggle="modal" class="btn btn-primary" data-bs-target="#sourceModal" onclick="openNewSourceForm()">↵      + Add Data Source↵    </button>
