...
- Name: dailies.spec.js >> Yearly Goals Tab >> Add Goal button should open modal
- Location: tests/e2e/dailies.spec.js:120:3
...
Call log:
  - waiting for locator('button:has-text("+ Add Goal")')
    - locator resolved to <button id="addGoalBtn" data-bs-toggle="modal" class="btn btn-primary" data-bs-target="#goalModal">↵      + Add Goal↵    </button>
